...
5. Select **Next**, leave **Login settings** empty, and then select **Save**. [2]
6. Open the **Credentials** tab and copy the **Client secret**. This secret is used to request tokens for the client. [5][2]

## Assign the `mcp-access` role
...
## Configure the access token lifespan
...
## Generate a token for chat-based usage
