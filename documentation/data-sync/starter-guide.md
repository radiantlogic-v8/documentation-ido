...
Next, use the Query Builder or the Explore page to confirm that objects have been uploaded successfully. If the results appear empty, it indicates that the data upload has not been completed.
