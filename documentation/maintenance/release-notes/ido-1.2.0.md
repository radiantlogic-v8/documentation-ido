...
- **ID-2105** – Updated existing home pages for Line Manager, Repository Manager, Resource Manager, and Technical Administrator roles; added new home pages for Technical Account Manager and Group Manager roles.  
- **ID-2331** – Added a new home page for users with the **user** role.  
